<?php
/**
 * Fixed Exhibits Database Setup for Phase 1 Integration
 * Simplified SQL statements to avoid execution issues
 */
...
echo "<h1>🎯 Phase 1: Exhibits Database Setup (Fixed)</h1>\n";
echo "<style>
...
try {
    ...
    // Step 1: Create exhibits table with simplified structure
    ...
    $category_stmt = $pdo->prepare("INSERT INTO categories (id, label, description, sort_order) VALUES (?, ?, ?, ?)");
    ...
    echo "<ol>";
    echo "<li>✅ <strong>Database setup complete</strong></li>";
...
echo "<hr><p><small>Phase 1 Database Setup (Fixed) | " . date('Y-m-d H:i:s T') . "</small></p>";
?>
