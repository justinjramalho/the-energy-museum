...
// Get the exhibition ID from the URL path
$request_uri = $_SERVER['REQUEST_URI'];
$path = parse_url($request_uri, PHP_URL_PATH);
$segments = explode('/', trim($path, '/'));

// Find the exhibition ID (should be the last segment)
$exhibition_id = end($segments);

if (empty($exhibition_id) || $exhibition_id === 'comments.php') {
